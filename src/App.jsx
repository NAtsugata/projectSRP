...
const AdminDashboardContainer = lazyWithRetry(() => import('./pages/AdminDashboardContainer'));
const AdminPlanningViewContainer = lazyWithRetry(() => import('./pages/AdminPlanningViewContainer'));
const AdminLeaveViewContainer = lazyWithRetry(() => import('./pages/AdminLeaveViewContainer'));
const AdminUserViewContainer = lazyWithRetry(() => import('./pages/AdminUserViewContainer'));
const AdminVaultViewContainer = lazyWithRetry(() => import('./pages/AdminVaultViewContainer'));
const AdminArchiveViewContainer = lazyWithRetry(() => import('./pages/AdminArchiveViewContainer'));
const AdminExpensesViewContainer = lazyWithRetry(() => import('./pages/AdminExpensesViewContainer'));
const AdminChecklistTemplatesViewContainer = lazyWithRetry(() => import('./pages/AdminChecklistTemplatesViewContainer'));
const AdminContractsViewContainer = lazyWithRetry(() => import('./pages/AdminContractsViewContainer'));
const ContractDetailViewContainer = lazyWithRetry(() => import('./pages/ContractDetailViewContainer'));
const AdminMonthlyExportViewContainer = lazyWithRetry(() => import('./pages/AdminMonthlyExportViewContainer'));
const AdminOrganizationsViewContainer = lazyWithRetry(() => import('./pages/AdminOrganizationsViewContainer'));
const AdminClientsViewContainer = lazyWithRetry(() => import('./pages/AdminClientsViewContainer'));
const AdminInvoicesViewContainer = lazyWithRetry(() => import('./pages/AdminInvoicesViewContainer'));
const AdminCatalogViewContainer = lazyWithRetry(() => import('./pages/AdminCatalogViewContainer'));
const QuoteEditorPage = lazyWithRetry(() => import('./pages/QuoteEditorPage'));
const OrganizationSettingsPage = lazyWithRetry(() => import('./pages/OrganizationSettingsPage'));
const CompanySettings = lazyWithRetry(() => import('./pages/CompanySettings'));
const ChantiersView = lazyWithRetry(() => import('./pages/ChantiersView'));
const ChantierDetailView = lazyWithRetry(() => import('./pages/ChantierDetailView'));
const SmartPlanningManager = lazyWithRetry(() => import('./components/SmartPlanningManager'));

const EmployeePlanningViewContainer = lazyWithRetry(() => import('./pages/EmployeePlanningViewContainer'));
const EmployeeLeaveViewContainer = lazyWithRetry(() => import('./pages/EmployeeLeaveViewContainer'));
const CoffreNumeriqueViewContainer = lazyWithRetry(() => import('./pages/CoffreNumeriqueViewContainer'));
const AgendaViewContainer = lazyWithRetry(() => import('./pages/AgendaViewContainer'));
const InterventionDetailViewContainer = lazyWithRetry(() => import('./pages/InterventionDetailViewContainer'));
const IRShowerFormsViewContainer = lazyWithRetry(() => import('./pages/IRShowerFormsViewContainer'));
const ExpensesViewContainer = lazyWithRetry(() => import('./pages/ExpensesViewContainer'));
const ChecklistViewContainer = lazyWithRetry(() => import('./pages/ChecklistViewContainer'));
const MyDocumentsViewContainer = lazyWithRetry(() => import('./pages/MyDocumentsViewContainer'));
const MobileDiagnosticsPageContainer = lazyWithRetry(() => import('./pages/MobileDiagnosticsPageContainer'));
const MobileMenu = lazyWithRetry(() => import('./pages/MobileMenu'));
const CerfaManager = lazyWithRetry(() => import('./pages/CerfaManager'));
const CerfaPage = lazyWithRetry(() => import('./pages/CerfaPage'));
const CerfaPage15498 = lazyWithRetry(() => import('./pages/CerfaPage15498'));
const CerfaPage1301 = lazyWithRetry(() => import('./pages/CerfaPage1301'));
const CalculateurAidesView = lazyWithRetry(() => import('./pages/CalculateurAidesView'));
