...
export const ELEMENT_CATALOG = {
  ...
  shower_door: {
    label: 'Porte de douche',
    category: 'shower',
    defaultWidth: 70, defaultDepth: 2, defaultHeight: 200,
    color: '#bae6fd',
    opacity: 0.4,
    shape: 'box',
    icon: '🚪',
  ...
  shower_corner: {
    label: "Paroi d'angle",
    category: 'shower',
    defaultWidth: 90, defaultDepth: 90, defaultHeight: 200,
    color: '#bae6fd',
    opacity: 0.4,
    shape: 'box',
    icon: '⌐',
  ...
  shower_cabin: {
    label: 'Cabine fermée',
    category: 'shower',
    defaultWidth: 90, defaultDepth: 90, defaultHeight: 205,
    color: '#bae6fd',
    opacity: 0.35,
    shape: 'box',
    icon: '⬚',
  ...
  shower_column: {
    ...
    category: 'shower',
    defaultWidth: 26, defaultDepth: 16, defaultHeight: 210,
    color: '#cbd5e1',
    shape: 'box',
    icon: '🚿',
  },
  ...
  faucet: {
    label: 'Robinet',
    category: 'sanitary',
    defaultWidth: 12, defaultDepth: 14, defaultHeight: 30,
    color: '#d4d4d8',
    shape: 'box',
    icon: '🚰',
  },
