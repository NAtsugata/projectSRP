 ...
 * ====================================================================
 * Sélecteur de thème optimisé pour mobile
 * Fonctionnalités:
...
/**
 * Sélecteur de thème avec gros boutons (adapté mobile)
 */
  ...
  return (
    <div className={`mobile-theme-selector ${fullWidth ? 'full-width' : ''}`}>
      <button
        ...
        aria-pressed={theme === THEMES.LIGHT}
      >
        <span className="theme-button-icon">☀️</span>
        <span className="theme-button-label">Thème Clair</span>
      ...
      >
        ...
        <span className="theme-button-label">Thème Sombre</span>
...
/**
 * Version avec icône seule (très compact)
 */
...
/**
 * Carte de préférence de thème (pour page de paramètres)
 */
export const MobileThemeCard = () => {
  ...
  return (
    <div className="mobile-theme-card">
      ...
      <p className="card-description">Choisissez le thème de l'application</p>
      ...
      <div className="theme-options">
        ...
        >
          ...
          {theme === THEMES.LIGHT && <span className="option-check">✓</span>}
        </button>
        ...
        >
          ...
          {theme === THEMES.DARK && <span className="option-check">✓</span>}
        </button>
        ...
        >
          ...
          {theme === THEMES.AUTO && <span className="option-check">✓</span>}
        </button>
      </div>
    </div>
  );
